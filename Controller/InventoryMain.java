...
/**
 * This class creates an arrayList and Inventory objects are stored in it
...
public class InventoryMain {
    ...
    public static void main(String args[]) {
        /**
         * The list is created to store different inventory objects
         * Thus helps to maintain the inventory items
         */

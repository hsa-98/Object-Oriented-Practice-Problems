...
public class StocksMain {
    public static void main(String args[]){
        ...
        StockServiceInterface stockServiceInterface = new StocksService();
        ...
        while (choice != 10) {
            ...
            switch (choice) {
                case 1:
                    ...
                    jsonArray = stockServiceInterface.addStock(jsonArray,stocks);
                ...
                case 2:
                    ...
                    jsonArray = stockServiceInterface.updateStock(jsonArray,nameChange , priceNew ,quantityNew);
                    break;
                ...
                case 4:
                    ...
                    jsonArray= stockServiceInterface.deleteStock(jsonArray, nameDelete);
                    break;
